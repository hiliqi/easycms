...
if (! function_exists('getCates')) {
    function getCates($order, $where, $num)
    {
        $models = cache('cates:' . $order . $where . $num);
        if ($models == false) {
            $models = \app\common\model\Category::getCates($order, $where, $num);
            cache('cates:' . $order . $where . $num, $models);
        }
        return $models;
    }
}
...
if (! function_exists('getSites')) {
    function getSites($order, $where, $num)
    {
...
if (! function_exists('getApps')) {
    function getApps($order, $where, $num)
    {
